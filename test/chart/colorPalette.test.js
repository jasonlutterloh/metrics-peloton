import {GREY, colors, getDefaultColorArray, getColorBasedOnArrayLengthAndIndex, getColorArrayBasedOnLength} from '../../src/chart/colorPalette';
...
describe('getColorBasedOnArrayLengthAndIndex', () => {
    ...
    it('should throw an error if index is out of range', () => {
        expect(()=>{getColorBasedOnArrayLengthAndIndex(1,2)}).toThrow();
    })
})
