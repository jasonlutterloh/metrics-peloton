...
beforeEach(() => {
  sampleData = [
    { title: "45 min HIIT Ride", output: 400, duration: 45, date: "2020-02-21", instructor: "Ben Alldis", distance: 15.5 },
    { title: "45 min Tabata Ride", output: 300, duration: 45, date: "2020-02-21", instructor: "Ben Alldis", distance: 15 },
    { title: "30 Min Climb Ride", output: 200, duration: 30, date: "2020-02-20", instructor: "Ben Alldis", distance: 10 },
    { title: "45 min HIIT Ride", output: 350, duration: 45, date: "2020-02-19", instructor: "Ben Alldis", distance: 15 },
    { title: "30 min Tabata Ride", output: 200, duration: 30, date: "2020-02-18", instructor: "Ben Alldis", distance: 10 },
    { title: "20 min Climb Ride", output: 100, duration: 20, date: "2020-02-17", instructor: "Robin Arzon", distance: 10 },
    { title: "45 min Tabata Ride", output: 300, duration: 45, date: "2020-02-16", instructor: "Robin Arzon", distance: 15 },
    { title: "30 min Ministry of Sound: I Love Ibiza", output: 200, duration: 30, date: "2020-02-15", instructor: "Robin Arzon", distance: 10 },
    { title: "30 min Tabata Ride: Live From Home", output: 200, duration: 30, date: "2020-02-14", instructor: "Robin Arzon", distance: 10 },
    { title: "20 min XOXO Cody", output: 110, duration: 20, date: "2020-02-13", instructor: "Alex Touisant", distance: 10 },
  ];
});
